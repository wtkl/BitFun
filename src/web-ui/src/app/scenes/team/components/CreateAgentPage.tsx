...
const CreateAgentPage: React.FC = () => {
  ...
  const { openAgentsOverview } = useTeamStore();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      notification.success(t('agentsOverview.form.createSuccess', `已创建 Agent「${name.trim()}」`));
      openAgentsOverview();
    } catch (err) {
      notification.error(
  ...
  return (
    <div className="tv">
      ...
      <div className="tv__editor-bar">
        <button className="tv__back-btn" onClick={openAgentsOverview}>
          <ArrowLeft size={14} />
        ...
        <div className="th__list-inner">
          ...
          <div className="th-create-page__form">
            ...
            <div className="th-create-page__actions">
              <Button variant="secondary" size="small" onClick={openAgentsOverview} disabled={submitting}>
